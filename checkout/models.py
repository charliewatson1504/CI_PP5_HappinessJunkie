...
class Order(models.Model):
    ...
    def update_total(self):
        ...
        if self.order_total < settings.FREE_SHIPPING_THRESHOLD:
            ...
            self.shipping_cost = self.order_total * sdp / 100
        else:
...
class OrderLineItem(models.Model):
    """
    Class for a model for order line items
    """
    ...
    product_zodiac_style = models.CharField(
        max_length=30,
        null=True,
        blank=True
    )
    product_foil_print_color = models.CharField(
        max_length=30,
        null=True,
        blank=True
    )
